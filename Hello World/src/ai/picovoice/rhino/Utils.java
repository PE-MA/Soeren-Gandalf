	...
	private static String getEnvironmentName() throws RuntimeException {
		...
		if (os.contains("mac") || os.contains("darwin")) {
			...
			if (arch.equals("arm") || arch.equals("aarch64")) {
				...
				default:
					throw new RuntimeException(String.format(
							"Execution environment not supported. " + "Rhino Java does not support CPU Part (%s).",
							cpuPart));
				}
			}
			return "linux";
			...
			throw new RuntimeException(
					"Execution environment not supported. " + "Rhino Java is supported on MacOS, Linux and Windows");
		}
	}
